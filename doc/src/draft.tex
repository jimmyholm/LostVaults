...
\subsection{Design}
Systemarkitekturen som beskrivs i detta dokument är uppdelat i två delar vilka beskriver akritekturen för klienten samt servern. På grund av att både klienten och servern är skrivna i Scala och körs via Java Virtual Maschine kan både servern och klienten köras på alla plattformar som stödjer Java VM 1.7.
\begin{figure}[hbt]
\centering
